...
<body background="images/golf.jpg" style="background-attachment: fixed" >
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 14pt"><b>Clave: </b></label></td>
			<td witdh=80><input style="border-radius:15px;" type="password" name="clave"></td></tr>
		<tr><td></td>
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input type="text" name="usuario" class="form-control" required placeholder="Ingresa tu nombre de Usuario" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt"><b>Ingresa tu Clave</b></label>
      <input type="password" name="clave" class="form-control"  required placeholder="Ingresa contraseña" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt"><b>Repite tu Clave</b></label>
      <input type="password" name="rclave" class="form-control" required placeholder="Repite contraseña" />
    </div>
    <div class="form-group">
